// Ported verbatim from Dashboard/auth/email.js's inviteHtml().
export function inviteEmailHtml({
  ...
  <div style="background:#0f1117;border:1px solid #1e2230;border-radius:16px;padding:40px;max-width:480px;width:100%">
    ...
    <p style="color:#6b7280;font-size:14px;margin:0 0 28px">${invitedBy} has invited you to access the GP Bookkeeper Operations Hub. Click the button below to set up your account.</p>
    ...
    <p style="color:#374151;font-size:11px;margin:24px 0 0">This link expires in 24 hours. If you weren't expecting this invitation, you can safely ignore it.</p>
  </div></div></body></html>`;
}
