...
export default async function AsanaTrackersPage() {
    ...
    <div className="shellPage dpPage">
      <div className="dpHeader">
        <div className="dpHeaderLeft">
          <div className="dpTitle">Asana — Trackers</div>
          <div className="dpSub">Priority trackers &amp; every active compliance tracker</div>
        </div>
      ...
      {!live ? (
        ...
        <TrackersDashboard initial={asana} />
      )}
    </div>
  );
}
