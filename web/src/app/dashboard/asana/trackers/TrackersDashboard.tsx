...
// Content cleared on request, starting from blank — see AsanaDashboard.tsx
// (Overview) for the note on where the previous content went.
export default function TrackersDashboard({ initial }: { initial: AsanaOverview }) {
  ...
  return (
    <div style={{ display: "flex", gap: 24, alignItems: "flex-start", flexWrap: "wrap" }}>
      ...
      <ControlPanelShell storageKey="asana-trackers">
